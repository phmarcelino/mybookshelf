...
$id_book = $_GET['id'];
$book = $databaseBook->getBookUpdate($id_book);

$genres = ['Romance', 'Ação', 'Ficção', 'Literatura', 'Distopia', 'Terror'];
$selectedGenres = explode(',', $book['genre']);
...
<html lang="pt-br">
    ...
    <body>
        ...
        <form action="update.php" enctype="multipart/form-data" method="post" class="container">
            <div class="form-group col-md-8 offset-md-2">
                ...
                <input type="number" class="form-control" id="pages-input"min="1" max="9999" name="pages" value="<?= $book['pages']; ?>">
                ...
                <select class="form-control" id="publi-input" name="publi">
                    <?php $book['publi'] == 'Nacional' ? $nacional = 'selected' : $nao_nacional = 'selected';?>
                ...
                <textarea class="form-control" id="desc-input" name="describe" rows="3" maxlength="2000"><?= $book['description']; ?></textarea>
